...
// 1. NUTZE NIEMALS die FileTools (Desktop Commander) vom echo_ai_soul MCP (REMOTE), sondern immer die lokalen FileTools der IDE.
...
// 9. Referenzpläne unter .echo/plans/ — LIES SIE VOR JEDER GRÖSSEREN ENTSCHEIDUNG. Dateinamen neuer Pläne beginnen immer mit "new_". Alle Pläne sind in Markdown. Wenn du eine Planimplementierung abgeschlossen hast benenne den Plan um und editiere das Präfix "new_" zu "done_".
